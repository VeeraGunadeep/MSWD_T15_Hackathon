    ...
    return(
        <div className="from-container">
            ...
            <form action="POST">
                ...
                <input type="remarks" onChange={(e) => { setSubject(e.target.value) }} placeholder="Remarks"/>
                <input type="Address" onChange={(e) => { setSubject(e.target.value) }} placeholder="Address"/>
